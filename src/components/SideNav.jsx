...
const SideNav = ({ activeTab, onTabChange }) => {
    ...
    const tabs = [
        ...
        { id: '운동', label: t('nav.routine'), icon: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        { id: '코치', label: t('nav.coach', { defaultValue: '코치' }), icon: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h.01M15 12h.01M19 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2z" />
            </svg>
        )}
    ];
